$(document).ready(function(){
	...
	//Aggiunta Gammariello del typehead per la ricerca delle città anche in modifica
...
var citiesSuggest2 = new Bloodhound({
  datumTokenizer: Bloodhound.tokenizers.whitespace,
  queryTokenizer: Bloodhound.tokenizers.whitespace,
  local: cities
});
    ...
    $('#modpatinfo').validate({
        rules: {
			...
			modsesso: "required",
			modcittanascita: "required",
			modcittaresidenza: "required",
			modviaresidenza: "required",
			//Aggiunta Gammariello per obbligatorietà dello stato matrimoniale
			modmaritalStatus: "required",
			modtel: {
                required: true,
                digits: true
            }
		...
		submitHandler: function(event) { 
			$.post("formscripts/modpatinfo.php",
			{
				cognome:		$("#modcognome").val(),
				nome:			$("#modnome").val(),
				cf:				$("#modcf").val(),
				datanascita:	$("#moddatanascita").val(),
				sesso:			$("#modsesso").val(),
				cittanascita:	$("#modcittanascita").val(),
				cittaresidenza:	$("#modcittaresidenza").val(),
				viaresidenza:	$("#modviaresidenza").val(),
				tel:			$("#modtel").val(),
				email:			$("#modemail").val(),
				//Modifiche Gammariello: controllo recupero della variabile dal form da inviare via post
				maritalStatus:	$("#modmaritalStatus").val(),
			},
  			function(status){
				//$('#modpatinfo')[0].reset();
    			alert("Status: " + status);
