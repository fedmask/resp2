...
function updateInputForm() {
	...
	document.getElementById("updateInputForm").action = "/api/fhir/Immunization/"
			+ document.getElementById("vaccinazione_id").value;
...
function openInputFileUpdate(id) {
	...
	document.getElementById("vaccinazione_id").value = id;
