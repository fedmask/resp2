                            ...
                            <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-3"><input id="numOrdine" name="numOrdine" type="text" class="form-control" placeholder = "numero di iscrizione ordine">
										 ...
										 <label for="registrationCity" class="control-label col-lg-3">Localit� Iscrizione *</label>
										<div class="col-lg-3">
											<input id="registrationCity" name="registrationCity" type="text" class="form-control" placeholder = "Localit� ordine di iscrizione">
